...
- **Code** (examples, starter code): [PolyForm Noncommercial 1.0.0](https://polyformproject.org/licenses/noncommercial/1.0.0/).

For commercial use or to create and share an adaptation, [reach out](https://github.com/dmill166) — it may well be welcome. These licenses cover my original work only; courses *reference* their textbooks (e.g., by chapter) but never reproduce them.
