...
Before anything else, get Python working on your computer. The [Install Python guide](guides/install-python.md) walks you through it on macOS, Windows, or Linux — no experience needed, about 15–20 minutes.
