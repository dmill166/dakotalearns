...
As I was thinking over this last week about what my next post would be, I kept coming to a road block. In a technical sense, I did not feel I learned anything ground-breaking or revelatory. Additionally, it was a busy time for me in a non-technical way (things outside of work). However, a couple of conversations with friends stirred up this sense of déjà vu; I caught myself repeating advice and conversation topics time and time again. Following the [DRY (Don't Repeat Yourself) principle](https://en.wikipedia.org/wiki/Don%27t_repeat_yourself), it was time to turn it into a blog post! Much like Elon Musk's timeline (calling out the [Oct 27 - Nov 17 rapidly successive series of headlines](https://www.ign.com/articles/elon-musks-twitter-takeover-and-the-chaos-that-followed-the-complete-timeline)), I will stop 'twit'ling my thumbs and get to the topic of levelling up in the job market!

1. [Assess the current-state](https://dakotalearns.wordpress.com/2022/12/05/level-up-in-the-job-market/#assess-the-current-state)
2. [Identify opportunities and level up](https://dakotalearns.wordpress.com/2022/12/05/level-up-in-the-job-market/#identify-opportunities-and-level-up)
3. [Plan, plan, plan](https://dakotalearns.wordpress.com/2022/12/05/level-up-in-the-job-market/#plan-plan-plan)
4. [Build the habit(s) routine(s)](https://dakotalearns.wordpress.com/2022/12/05/level-up-in-the-job-market/#build-the-habit-s-routine-s)
5. [Execute](https://dakotalearns.wordpress.com/2022/12/05/level-up-in-the-job-market/#execute)
6. [Persevere](https://dakotalearns.wordpress.com/2022/12/05/level-up-in-the-job-market/#persevere)
7. [Summary and Links](https://dakotalearns.wordpress.com/2022/12/05/level-up-in-the-job-market/#summary-and-links)
8. [Conclusion](https://dakotalearns.wordpress.com/2022/12/05/level-up-in-the-job-market/#conclusion)

![](https://dakotalearns.wordpress.com/wp-content/uploads/2022/12/51807778847_99e0c7bec4_o.jpg?w=1024)
...
It is great to know where you stand, but in this day and age (where [the most recent Consumer Price Index](https://www.bls.gov/news.release/cpi.nr0.htm), or key measure of inflation, rose 7.7%), it can be hard to justify making that move without something else lined up. Continuing from that, how can you know what opportunities exist? A quick Google search of `job boards` showed me the [Betterteam website discussing the Best Job Boards for 2022](https://www.betterteam.com/job-boards). Ironically, their top three suggestions (Indeed, Google Jobs, LinkedIn) are also my go-to for my own career ventures:

1. [Indeed](https://www.indeed.com/)
   * After creating an account and customizing your profile, navigation to Indeed will result in a search bar of "What" (to define the job title, keywords, or company that interests you) and "Where" (allowing options such as a physical location [city, state, zip] or type of work like `remote`). Plus, most of the page will result in an updated Job Feed (improved by your continued activity within Indeed) suggesting opportunities that should, to some degree, match your interests for employment ventures.
   * While finding jobs is by far the most known feature of Indeed, they also now include "Company Reviews" (giving you details about the company, employee reviews of their experience, salary submissions by former/current employees, comments about benefits, job postings for the company, and so much more). Another module now existing is "Find salaries"; if you're investigating your compensation to see if it's competitive or are considering a career change, this is a great place to research those details.
2. [Google Jobs](https://jobs.google.com/about/)
...
* *"I lack the knowledge to do well at this job/the job I really want"* (Thanks [ColorWhistle for these six examples of online educational platforms](https://colorwhistle.com/top-online-learning-platforms/)!)
...
* *"I need to go learn from the experts and talk to others to get inspired/knowledgeable for my next step"*
  + [EventBrite](https://www.eventbrite.com/) has a collection of in-person and online conferences listed in a central location. Whether it's for personal reasons (like a visit to a comedy club) or professional (such as career fairs and training seminars, as we care more about for the purposes of this blog post), EventBrite might have you covered
* "I only learn well when I read it, but books cost money"
  + [OpenLibrary](https://openlibrary.org/)
  + [Project Gutenberg](https://www.gutenberg.org/3)
  + [Goodreads](https://www.goodreads.com/)

[Regardless of what industry you're in, CU Boulder found common skills that enable success in one's career](https://www.colorado.edu/today/2019/04/17/10-essential-skills-youll-need-career-success). If technical prowess isn't where you need to advance, try further developing these skills:
...
![](https://upload.wikimedia.org/wikipedia/commons/b/bf/Why-are-goals-important.jpg)

<https://commons.wikimedia.org/wiki/File:Why-are-goals-important.jpg>

In order to progress with something in a significant fashion (such as the personal and professional development we've been discussing), you need an organized approach to meet these goals. That's where S.M.A.R.T. goals come in. I'll quote [Atlassian's article](https://www.atlassian.com/blog/productivity/how-to-write-smart-goals) as I don't think I can say it any better:
...
1. I've purposefully built this task into my daily routine to ensure it happens. It's done by intention rather than casual remembrance
2. I've built in alternate solutions (apartment gym treadmill) should the normal approach (walking outside) not feel like an ideal option
3. I've partnered with my wife to express the importance of this task to her so she can help me succeed in it
...
* [News Article discussing Twitter timeline](https://www.ign.com/articles/elon-musks-twitter-takeover-and-the-chaos-that-followed-the-complete-timeline) (used in dad joke)
* [Inflation as of November 2022](https://www.bls.gov/news.release/cpi.nr0.htm)
* [2022 Best Job Boards](https://www.betterteam.com/job-boards)
* [Indeed.com](https://www.indeed.com/)
* [Google Jobs About page](https://jobs.google.com/about/)
  + (to use Google Jobs, search your desired job title at [google.com](http://google.com) and click the "Jobs" heading towards the top of your results page)
* [LinkedIn Jobs](https://www.linkedin.com/jobs/)
* [Six Online Learning Platforms](https://colorwhistle.com/top-online-learning-platforms/)
  + [Coursera](https://www.coursera.org/)
  + [Skillshare](https://www.skillshare.com/)
  + [LinkedIn Learning](https://www.linkedin.com/learning/)
  + [Udacity](https://www.udacity.com/)
  + [Udemy](https://www.udemy.com/)
  + [edX](https://www.edx.org/)
* [EventBrite](https://www.eventbrite.com/): "the leading events management and growth platform helping creators and entrepreneurs thrive"
* Three sample online PDF/Book resources:
  + [OpenLibrary](https://openlibrary.org/)
  + [Project Gutenberg](https://www.gutenberg.org/3)
  + [Goodreads](https://www.goodreads.com/)
* [CU Boulder Soft Skills to Improve](https://www.colorado.edu/today/2019/04/17/10-essential-skills-youll-need-career-success)
* [Atlassian on S.M.A.R.T. Goals](https://www.atlassian.com/blog/productivity/how-to-write-smart-goals)
* [Build routines, not habits - Harvard Business Review](https://hbr.org/2021/02/what-does-it-really-take-to-build-a-new-habit)
* Sample Workout Program - [Jim Stoppani's 12-Week Shortcut to Size](https://www.bodybuilding.com/workout-plans/about/jim-stoppanis-12-week-shortcut-to-size)
