...
|---|---|---|---|---|
| **[CS 1050 — Computer Science 1](cs1050/index.md)** | Computer Science | `Python` `Beginner` `MSU-aligned` | First programming course, in Python. Zero experience assumed. | 🟢 In progress |
